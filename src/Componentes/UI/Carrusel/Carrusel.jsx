...
const Carrusel = ({ imagenes, intervalo = 5000 }) => {
    ...
    if (!imagenes || imagenes.length === 0) {
        return (
            <div className="bg-gray-200 h-[340px] sm:h-[480px] lg:h-[560px] xl:h-[640px] flex items-center justify-center rounded-lg shadow-md mb-12 w-full text-gray-700 text-xl">
    ...
    return (
        <div className="relative w-full h-[340px] sm:h-[480px] lg:h-[560px] xl:h-[640px] rounded-xl shadow-2xl group overflow-hidden">
            <div 
