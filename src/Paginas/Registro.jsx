...
const Registro = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
            <Helmet>
                <title>Sitio en Construcción - Gaddyel</title>
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-2xl">
                <div className="text-center">
                    ...
                    <div className="mt-4 text-left bg-amber-50 border-l-4 border-amber-500 p-4">
                        <p className="text-sm text-gray-700 mb-2">
                            <strong>Registro de nuevos usuarios temporalmente deshabilitado</strong>
                        </p>
                        <p className="text-sm text-gray-700">
                            Estamos realizando mejoras en el sistema. El registro estará disponible próximamente.
                        </p>
                    </div>
