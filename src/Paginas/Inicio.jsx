...
import TarjetaProducto from '../Componentes/TarjetaProducto/TarjetaProducto.jsx'; // Nuevo: Importar TarjetaProducto
                ...
                <div className="container mx-auto overflow-hidden">
                    ...
                    <section className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 bg-gray-50 rounded-2xl my-72 shadow-xl">
                        <div className="flex flex-col items-center w-full">
                            <h2 className="italic text-3xl md:text-4xl font-bold text-center text-gray-800 mb-6 md:mb-8 shrink-0">Nuestros Destacados</h2>
                            <ScrollReveal>
                    ...
                    <section className="min-h-screen flex items-center justify-center flex-col p-4 md:p-8 bg-white rounded-2xl my-72 shadow-xl">
                        <h2 className="italic text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8">Productos que te Encantarán</h2>
                        {productosDestacados.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {productosDestacados.map(producto => (
                                    <ScrollReveal key={producto.id}>
                                        <TarjetaProducto producto={producto} fixedHeight={true} /> {/* Nuevo: Usar TarjetaProducto */}
                                    </ScrollReveal>
                                ))}
                            </div>
                        ) : (
