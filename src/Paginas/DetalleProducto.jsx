...
const DetalleProducto = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{`${producto.nombre} - ${producto.categoria} | Gaddyel`}</title>
                <meta name="description" content={`Detalles completos de ${producto.nombre}. Descubre las características, calidad y precio de nuestro producto de ${producto.categoria}.`} />
            </Helmet>
